...
% TITLE BLOCK
% ============================================
\title[Using AI as a Junior Dev]{Using AI to Build as a Junior Developer}
...
\begin{frame}{What I'm gonna talk about}
    \begin{itemize}
        \item A little about me (2 mins)
        \item 2 cases: A weekend project \& an actual feature (10 mins)
        \item What's worked for me and what hasn't (4 mins)
        \item Well okay what now? (2 mins)
    \end{itemize}
...
\begin{frame}{Fin.}
    ...
    \vspace{2em}
    \normalsize
    hello@saisneha.com \textbar\ saisneha.com \textbar\ linkedin.com/in/snehasaisneha \textbar\ github.com/snehasaisneha
